...
public class ReactViewGroup extends ViewGroup
  ...
  public void setShadowRadius(float shadowRadius) {
    getOrCreateReactViewBackground().setShadowRadius(shadowRadius);
  }

  public void setShadowOffset(ReadableMap shadowOffset) {
    float shadowX = 0f;
    float shadowY = 0f;
    if (shadowOffset != null) {
      shadowX = shadowOffset.hasKey("width") ? (float) shadowOffset.getDouble("width") : 0f;
      shadowY = shadowOffset.hasKey("height") ? (float) shadowOffset.getDouble("height") : 0f;
    }
    getOrCreateReactViewBackground().setShadowXShift(shadowX);
    getOrCreateReactViewBackground().setShadowYShift(shadowY);
  }

  public void setShadowOpacity(float shadowOpacity) {
    getOrCreateReactViewBackground().setShadowOpacity(shadowOpacity);
  }
  ...
  protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    ...
    if (this.mReactBackgroundDrawable != null) {
      this.mReactBackgroundDrawable.setBounds(0, 0, w, h);
      this.mReactBackgroundDrawable.updateShadowBitmap();
    }
  }
  ...
  protected void onAttachedToWindow() {
    ...
    if (this.mReactBackgroundDrawable != null) {
      this.mReactBackgroundDrawable.setAttachedToWindow(isAttachedToWindow());
      this.mReactBackgroundDrawable.updateShadowBitmap();
    }
  }
  ...
  public void onDetachedFromWindow() {
    ...
    if (this.mReactBackgroundDrawable != null) {
      this.mReactBackgroundDrawable.setAttachedToWindow(isAttachedToWindow());
      this.mReactBackgroundDrawable.destroyShadowBitmap();
    }
  }
