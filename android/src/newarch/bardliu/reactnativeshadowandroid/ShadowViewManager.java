...
import com.facebook.react.viewmanagers.ShadowViewManagerDelegate;
import com.facebook.react.viewmanagers.ShadowViewManagerInterface;
...
@ReactModule(name = ShadowViewManager.REACT_CLASS)
public class ShadowViewManager extends ReactClippingViewManager<ReactViewGroup> implements ShadowViewManagerInterface<ReactViewGroup> {
  @VisibleForTesting
  ...
  public ShadowViewManager(ReactApplicationContext context) {
    mDelegate = new ShadowViewManagerDelegate<>(this);
  }
  ...
  @Override
  public void hotspotUpdate(ReactViewGroup view, int x, int y) {
